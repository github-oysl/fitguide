...
const publicFiles=new Set(['index.html','detail-prototype.html','style.css','data.js','extra-data.js','activity-data.js','training.js','guide.js','plans.js','checkin-stats.js','dashboard.js','teachers-day.js','teachers-day.css','free-activity.js','guidance-status.json','使用说明.txt']);
