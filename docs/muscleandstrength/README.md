...
| `cable-curl-with-bar` | 直杆绳索弯举 | CABLE CURL WITH BAR | E03 可调绳索站（照片 20、22；低位滑轮＋短 | [Cable Tricep Extension With V-Bar](https://www.muscleandstrength.com/exercises/cable-tricep-extension-with-v-bar.html) | [视频](https://www.youtube.com/watch?v=KYGarkmUqvk) | [`cable-curl-with-bar.md`](tutorials/cable-curl-with-bar.md) |
...
| `dumbbell-curl` | 哑铃弯举 | DUMBBELL CURL | B01 哑铃架（背景器材，见 photo-audi | [Alternating Dumbbell Hammer Preacher Curl](https://www.muscleandstrength.com/exercises/alternate-dumbbell-hammer-preacher-curl.html) | - | [`dumbbell-curl.md`](tutorials/dumbbell-curl.md) |
